  ...
  return (
    <section id="catalogo" className="bg-white py-4 sm:py-8">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div
          className="top-16 z-30 -mx-4 flex flex-col gap-4 border-b border-graphite-100 bg-white/95 px-4 py-4 backdrop-blur sm:-mx-6 sm:px-6"
        >
